  ...
  const navLinks = (
    <>
      ...
      <div className="right-links">
        ...
        {/*  </LinkItem>*/}
        {/*</Away>*/}
        <Away href="https://github.com/orgs/onchainhub/discussions">
          <LinkItem>
            <span>Ask a question</span>
          </LinkItem>
        </Away>
        <Away href="https://github.com/onchainhub">
          <LinkItem>
            <span>GitHub</span>
            <Image width={20} height={20} alt="OnchainHub on GitHub" src={GitHubLogo} />
          </LinkItem>
        </Away>
        <NavItem to="/dashboard">Launch Dashboard</NavItem>
      </div>
    </>
  );
